 ...
 * @original_file minecraft-game-over.mkcd
...
// 2. Code Builder を開く
// 3. Import → dist/makecode/minecraft-game-over.mkcd
...
player.onChat("gameover", function () {
    // TODO: 抽出したコードをここに配置
    player.say("⚠️ このファイルはまだ変換中です。dist/makecode/minecraft-game-over.mkcd を使用してください。")
})
