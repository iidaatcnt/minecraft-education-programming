 ...
 * @category games
 * @chat_command spleef
 * @original_file minecraft-tnt-spleef.mkcd
...
// 2. Code Builder を開く
// 3. Import → dist/makecode/minecraft-tnt-spleef.mkcd
...
player.onChat("spleef", function () {
    // TODO: 抽出したコードをここに配置
    player.say("⚠️ このファイルはまだ変換中です。dist/makecode/minecraft-tnt-spleef.mkcd を使用してください。")
})
