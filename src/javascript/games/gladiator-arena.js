 ...
 * @original_file minecraft-gladiator.mkcd
...
// 2. Code Builder を開く
// 3. Import → dist/makecode/minecraft-gladiator.mkcd
...
player.onChat("gladiator", function () {
    // TODO: 抽出したコードをここに配置
    player.say("⚠️ このファイルはまだ変換中です。dist/makecode/minecraft-gladiator.mkcd を使用してください。")
})
