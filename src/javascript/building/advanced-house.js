 ...
 * @original_file minecraft-build-a-house.mkcd
...
// 2. Code Builder を開く
// 3. Import → dist/makecode/minecraft-build-a-house.mkcd
...
player.onChat("bighouse", function () {
    // TODO: 抽出したコードをここに配置
    player.say("⚠️ このファイルはまだ変換中です。dist/makecode/minecraft-build-a-house.mkcd を使用してください。")
})
