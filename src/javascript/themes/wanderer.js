 ...
 * @category themes
 * @chat_command wander
 * @original_file minecraft-wanderer.mkcd
...
// 2. Code Builder を開く
// 3. Import → dist/makecode/minecraft-wanderer.mkcd
...
player.onChat("wander", function () {
    // TODO: 抽出したコードをここに配置
    player.say("⚠️ このファイルはまだ変換中です。dist/makecode/minecraft-wanderer.mkcd を使用してください。")
})
