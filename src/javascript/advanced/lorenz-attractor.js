 ...
 * @category advanced
 * @chat_command lorenz
 * @original_file minecraft-lorenz-attractor.mkcd
...
// 2. Code Builder を開く
// 3. Import → dist/makecode/minecraft-lorenz-attractor.mkcd
...
player.onChat("lorenz", function () {
    // TODO: 抽出したコードをここに配置
    player.say("⚠️ このファイルはまだ変換中です。dist/makecode/minecraft-lorenz-attractor.mkcd を使用してください。")
})
