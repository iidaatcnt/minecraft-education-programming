 ...
 * @original_file minecraft-earthquake.mkcd
...
// 2. Code Builder を開く
// 3. Import → dist/makecode/minecraft-earthquake.mkcd
...
player.onChat("earthquake", function () {
    // TODO: 抽出したコードをここに配置
    player.say("⚠️ このファイルはまだ変換中です。dist/makecode/minecraft-earthquake.mkcd を使用してください。")
})
